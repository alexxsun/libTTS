...
public:
    ...
    // complex is computed
    void readGraph(char *name_in_file);  // set of arcs of a graph based on which
    // clicks are computed
    ...
    // xx note: return dimensions of top-simplexes. what are the dim of top-simplexes?
    ...
    // return: top-simplex corresponding to the input simplex encoded in the
    // explicit way
    ...
    // return: implicit representation of a simplex computed from its explicit
    // representation
    ...
    // return: top-simplexes on the coboundary of s (or, in other words, incident
    // to s)
...
protected:
    ...
    void
    recursive_insert(implicitS simplex, const implicitS &original, uint pos, uint dim, forward_list<implicitS> *ret);
